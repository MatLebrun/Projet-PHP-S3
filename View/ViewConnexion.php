           ...
           <?php if(!empty($_SESSION['erreur'])) {
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-email">
                        <input type="text" id="email" placeholder="Votre Pseudo" name="pseudo" value="<?php if(isset($email)) {echo $email;} ?>"/>
                    </div>
                    ...
                    <div>
                        <a href="../Controller/Recuperation.php" id="forgot-password">Mot de passe oublié</a>
                    </div>
                    ...
                    <a href="../Controller/inscription.php" id="to-register">Je n'ai pas de compte</a>
                </form>
