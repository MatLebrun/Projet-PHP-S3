    ...
    class User extends Model{
        ...
        */
        ...
        public static function checkConnexion($connect,$password){
            ...
            if(!password_verify($password, $results[0]['motdepasse'] )){return false;}

            return new User($results[0]['idUser'],$results[0]['prenom'],$results[0]['nom'],$results[0]['email'],$results[0]['pseudo'],$results[0]['motdepasse'],$results[0]['role']); 
